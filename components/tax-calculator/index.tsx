...
const Calculator = ({
  ...
  const calculatedSalary =
    calculatorState.salaryCurrency === 'CRC'
      ? calculatorState.salary || 0
      : calculatorState.exchangeRate * (calculatorState.salary || 0);

  const tractDeductible = (tract: Tract): number => {
    let tractDiff = 0;
          ...
          <div className='relative mt-1 font-mono rounded-md shadow-sm'>
            ...
            <input
              ...
              onChange={(e: ChangeEvent<HTMLInputElement>) =>
                setCalculatorState({
                  ...calculatorState,
                  salary: Math.abs(parseFloat(e.target.value)),
                })
              }
              placeholder='0.00'
              type='number'
          ...
          <div className='relative mt-1 font-mono rounded-md shadow-sm'>
            ...
            <input
              ...
              onChange={(e: ChangeEvent<HTMLInputElement>) =>
                setCalculatorState({
                  ...calculatorState,
                  exchangeRate: Math.abs(parseFloat(e.target.value)),
                })
              }
              placeholder='0.00'
              type='number'
